...
class BubbleTabIndicator extends Decoration {
  ...
  const BubbleTabIndicator({
    ...
    this.tabPadding = const EdgeInsets.symmetric(vertical: 2.0, horizontal: 8.0),
  ...
  Decoration? lerpFrom(Decoration? a, double t) {
    if (a is BubbleTabIndicator) {
      return BubbleTabIndicator(
        tabPadding: EdgeInsetsGeometry.lerp(a.padding, padding, t)!,
  ...
  Decoration? lerpTo(Decoration? b, double t) {
    if (b is BubbleTabIndicator) {
      return BubbleTabIndicator(
        tabPadding: EdgeInsetsGeometry.lerp(padding, b.padding, t)!,
...
class _BubblePainter extends BoxPainter {
  ...
  EdgeInsetsGeometry get tabPadding => decoration.tabPadding;
  EdgeInsetsGeometry get insets => decoration.insets;
  TabBarIndicatorSize get tabBarIndicatorSize => decoration.tabBarIndicatorSize;

  Rect _indicatorRectFor(Rect rect, TextDirection textDirection) {
    Rect indicator = tabPadding.resolve(textDirection).inflateRect(rect);
