...
extension StringExtensions on String {
  ...
  /// Allowing only "_", number and words
  bool isUsername1() => RegVal.hasMatch(this, RegexPattern.username1);
  ...
  /// from 7 - 15 characters
   bool isPhone1() => RegVal.hasMatch(this, RegexPattern.phone1);
  ...
  /// Allowing all character except 'whitespace'
  /// Minimum character: 8
  bool isPasswordEasyWithFixedLength() => RegVal.hasMatch(this, RegexPattern.passwordEasyWithFixedLength);
  ...
  bool isPasswordNormal4() =>
      RegVal.hasMatch(this, RegexPattern.passwordNormal4);

  /// Password (Normal) Regex
  /// Allowing all character except 'whitespace'
  /// Must contains at least: 1 uppercase letter, 1 number
  /// Minimum character: > 6
  bool isPasswordNormal5() =>
      RegVal.hasMatch(this, RegexPattern.passwordNormal5);
  ...
  /// Regex
  /// Must contains at least: 1 lowecase letter
  bool isLeastOneLetter() =>
      RegVal.hasMatch(this, RegexPattern.leastOneLetter);

  /// Regex
  /// Must contains at least: 1 uppercase letter, 1 lowecase letter & 1 number
  bool isLeastOneCapitalLetter() =>
      RegVal.hasMatch(this, RegexPattern.leastOneCapitalLetter);

  /// Regex
  /// Must contains at least:1 number
  bool isLeastOneNumber() =>
      RegVal.hasMatch(this, RegexPattern.leastOneNumber);

  /// Regex
  /// Must contains at least:1 Special
  bool isLeastOneSpecial() =>
      RegVal.hasMatch(this, RegexPattern.leastOneSpecialLetter);

  /// Regex
  /// Must contains at least: 1 uppercase letter & 1 number
  bool isLeastOneCapitalAndNumberLetter() =>
      RegVal.hasMatch(this, RegexPattern.leastOneCapitalAndNumberLetter);
}
