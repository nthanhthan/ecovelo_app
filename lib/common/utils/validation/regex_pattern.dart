...
class RegexPattern {
  ...
  /// Username regex
  static const Pattern username1 = r'^(?=.*[A-Za-z])[a-zA-Z0-9_]{0,30}$';
  ...
  static const Pattern phone = r'^(?:[+0][1-9])?[0-9]{10,14}$';
      //r'^(0|\+|(\+[0-9]{2,4}|\(\+?[0-9]{2,4}\)) ?)([0-9]*|\d{2,4}-\d{2,4}(-\d{2,4})?)$';

  /// Phone Number regex
  /// Only number accepted
  /// from 7 - 15 characters
  static const Pattern phone1 = r'^[0-9]{7,15}$';

  /// Hexadecimal regex
  static const Pattern hexadecimal = r'^#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$';

  /// Image vector regex
  static const Pattern vector = r'.(svg)$';

  /// Image regex
  static const Pattern image = r'.(jpeg|jpg|gif|png|bmp|heic)$';
  ...
  /// Password (Easy) Regex
  /// Allowing all character except 'whitespace'
  /// Number character: 10 - 20
  static const Pattern passwordEasyWithFixedLength = r'^\S{10,20}$';
  ...
  /// Allowing all character except 'whitespace'
  /// Must contains at least: 1 uppercase letter, 1 lowecase letter & 1 number
  /// Minimum character: 10 - 20
  static const Pattern passwordNormal4 =
      r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)\S{10,20}$';

  /// Password (Normal) Regex
  /// Allowing all character except 'whitespace'
  /// Must contains at least: 1 uppercase letter,  1 number
  /// Minimum character: > 6
  static const Pattern passwordNormal5 =
      r'^(?=.*[A-Z])(?=.*\d)\S{6,}$';
  ...
  /// Matches without spaces
  static final RegExp withoutSpaces = RegExp(r'\s');

  /// Matches least one letter
  static const Pattern leastOneLetter = r'^(?=.*[A-Za-z])';

  /// Matches least one capital letter
  static const Pattern leastOneCapitalLetter = r'^(?=.*[A-Z])';

  /// Matches least one number
  static const Pattern leastOneNumber = r'^(?=.*[0-9])';

  /// Matches least one special
  static const Pattern leastOneSpecialLetter = r'^(?=.*[\W_])';

  /// Matches least one capital letter and one number
  static const Pattern leastOneCapitalAndNumberLetter = r'^(?=.*[A-Z])(?=.*\d)';
}
