...
class Uuid {
  ...
  Map<String, dynamic> get _state => _stateExpando[this] ??= <String, dynamic>{
        'seedBytes': null,
        'node': null,
        'clockSeq': null,
        'mSecs': 0,
  ...
  static bool isValidUUID({String fromString = '', Uint8List? fromByteList, ValidationMode validationMode = ValidationMode.strictRFC4122}) {
  ...
  static void isValidOrThrow({String fromString = '', Uint8List? fromByteList, ValidationMode validationMode = ValidationMode.strictRFC4122}) {
    ...
    if (!isValid) {
      ...
      if (validationMode != ValidationMode.nonStrict) {
        final isValidNonStrict = isValidUUID(fromString: fromString, fromByteList: fromByteList, validationMode: ValidationMode.nonStrict);
  ...
  static Uint8List parseAsByteList(String uuid,
      {List<int>? buffer, int offset = 0, bool validate = true, ValidationMode validationMode = ValidationMode.strictRFC4122}) {
    return Uint8List.fromList(parse(uuid, buffer: buffer, offset: offset, validate: validate, validationMode: validationMode));
  }
  ...
  void _initV1() {
    final Map<String, dynamic> options = this.options ?? const <String, dynamic>{};

    if (!(_state['hasInitV1']! as bool)) {
      List<dynamic>? v1PositionalArgs = (options['v1rngPositionalArgs'] != null) ? options['v1rngPositionalArgs'] as List<dynamic> : <dynamic>[];
      var v1NamedArgs = (options['v1rngNamedArgs'] != null) ? options['v1rngNamedArgs'] as Map<Symbol, dynamic> : const <Symbol, dynamic>{};
      Uint8List seedBytes =
          (options['v1rng'] != null) ? Function.apply(options['v1rng'] as Function, v1PositionalArgs, v1NamedArgs) as Uint8List : UuidUtil.mathRNG();
  ...
  void _initV4() {
    final options = this.options ?? const <Symbol, dynamic>{};

    if (!(_state['hasInitV4']! as bool)) {
      // Set the globalRNG function to mathRNG with the option to set an alternative globally
      List<dynamic>? gPositionalArgs = (options['gPositionalArgs'] != null) ? options['gPositionalArgs'] as List<dynamic> : const <dynamic>[];
      var gNamedArgs = (options['gNamedArgs'] != null) ? options['gNamedArgs'] as Map<Symbol, dynamic> : const <Symbol, dynamic>{};

      _state['globalRNG'] =
          (options['grng'] != null) ? () => Function.apply(options['grng'] as Function, gPositionalArgs, gNamedArgs) : UuidUtil.mathRNG;
  ...
  String v1({Map<String, dynamic>? options}) {
    ...
    _initV1();
    int clockSeq = (options['clockSeq'] != null) ? options['clockSeq'] as int : _state['clockSeq'] as int;
    ...
    int mSecs = (options['mSecs'] != null) ? options['mSecs'] as int : (DateTime.now()).millisecondsSinceEpoch;

    // Per 4.2.1.2, use count of uuid's generated during the current clock
    // cycle to simulate higher resolution clock
    int nSecs = (options['nSecs'] != null) ? options['nSecs'] as int : (_state['nSecs']! as int) + 1;

    // Time since last uuid creation (in msecs)
    int dt = (mSecs - (_state['mSecs'] as int)) + (nSecs - (_state['nSecs'] as int)) ~/ 10000;
    ...
    // time interval
    if ((dt < 0 || mSecs > (_state['mSecs'] as int)) && options['nSecs'] == null) {
      nSecs = 0;
    }
    ...
    // node
    List<int> node = (options['node'] != null) ? options['node'] as List<int> : _state['node'] as List<int>;
    for (var n = 0; n < 6; n++) {
      buf[i + n] = node[n];
    }
  ...
  String v4({Map<String, dynamic>? options}) {
    ...
    List<dynamic>? positionalArgs = (options['positionalArgs'] != null) ? options['positionalArgs'] as List<dynamic> : <dynamic>[];
    ...
    List<int> rng = (options['rng'] != null)
        ? Function.apply(options['rng'] as Function, positionalArgs, namedArgs) as List<int>
        : (_state['globalRNG']! as Function)() as List<int>;

    // Use provided values over RNG
    List<int> rnds = (options['random'] != null) ? options['random'] as List<int> : rng;
  ...
  String v5(String? namespace, String? name, {Map<String, dynamic>? options}) {
    ...
    bool useRandom = (options['randomNamespace'] != null) ? options['randomNamespace'] as bool : true;
