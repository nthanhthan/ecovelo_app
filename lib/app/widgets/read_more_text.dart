...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    double defautlScaleFactor = MediaQuery.textScaleFactorOf(context);
    if (defautlScaleFactor > maxTextScaleFactorDef) {
      defautlScaleFactor = maxTextScaleFactorDef;
    }
    final textScaleFactor = widget.textScaleFactor ?? defautlScaleFactor;
            ...
            if (widget.trimLength < widget.data.length) {
              ...
              textSpan = TextSpan(
                ...
                text: _readMore
                    ...
                    : widget.data,
                //children: <TextSpan>[_delimiter, linkMore],
              );
            } else {
              textSpan = TextSpan(
                style: effectiveTextStyle,
